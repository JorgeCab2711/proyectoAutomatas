...
from Algorithms import Thompson, minimization, state_pairs, subsetConstruction, a_pairs, b_pairs
...
if __name__ == "__main__":
    ...
    if validarExpresionRegular(expresion):
        ...
        # for i in b_pairs(table):
        #     print(i)
        print(table["b"])
        counter = 0
        new = table
        for i in range(len(new["b"])):
            print("(", new["b"][i], ") generated by:" +
                  "S"+str(new["b"].index(new["b"][i])))
